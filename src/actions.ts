...
&qf=id+name%5E20+type%5E10+creator+lastModifier+text+text_ar+text_cjk+text_da+text_de+text_el+text_en+text_es+text_fi+text_fr+text_he+text_hi+text_it+text_ja+text_nl+text_no+text_pl+text_pt+text_pt_br+text_ru+text_sv+text_th+text_tr+text_zh_cn&wt=json\
&fq=classification:(content%20OR%20asset)&fq=type:(%22article%22)\
&fq=isManaged:(%22true%22)\
&fq=libraryId:(default%20OR%20ad4f44bf-edc0-466d-97b8-e1cd64af9efd)\
&sort=lastModified%20desc`;
// yuck!
